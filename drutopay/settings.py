"""
Django settings for drutopay project.
...
SECRET_KEY = 'django-insecure-2klea207&7%ly#lba92wm2w-4p!8lkmdnlmciz5q7kmw=wdk!!'
...
WSGI_APPLICATION = 'drutopay.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='drutopay'),
        'USER': config('DB_USER', default='drutopay'),
        'PASSWORD': config('DB_PASSWORD', default='drutopay'),
